...
export default function CampaignForm() {
  ...
  const handleTarget1Change = (index, e) => {
    ...
    updatedTargetPairs[index].target2 = null;
  ...
  const handleFormSubmit = async (e) => {
    ...
    const campaignSecGoalValue =
    refCampaignSecGoal?.current?.value?.trim() || ""; // Default to an empty string if value is undefined
            ...
            {secGoalState ? (
              <div className="flex-center">
                ...
                <select
                  ...
                  className="text-sm px-4 py-2 border border-grey"
                >
                  <option value="">Select Sec Goal</option>
